...
def screen_stocks(
    ...
    Args:
        ...
        columns: (required) list of fields to return, or empty list for default columns.
            ...
            Volatility: ATR, BB.upper, BB.lower, BBPower
            Volume/Flow: ChaikinMoneyFlow, average_volume_10d_calc, average_volume_30d_calc, relative_volume_10d_calc
            ...
            Performance: Perf.W, Perf.1M, Perf.3M, Perf.6M, Perf.3Y, Perf.5Y, Perf.YTD, Perf.5D
