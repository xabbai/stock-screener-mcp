...
# `stock-screener-mcp --transport stdio` through a real MCP stdio client, runs the README
...
STOCK_SCREENER_MCP_BROWSER_COOKIES=off "$TMP/venv/bin/python" - "$TMP/venv/bin/stock-screener-mcp" <<'PY'
